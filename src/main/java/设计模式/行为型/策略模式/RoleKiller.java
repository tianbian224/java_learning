package 设计模式.行为型.策略模式;//  Lvcang created at  2017-11-09 16:06

import 设计模式.行为型.策略模式.BehaviorInterface.Weapon;
import 设计模式.行为型.策略模式.BehaviorImplement.MoveSwim;
import 设计模式.行为型.策略模式.BehaviorImplement.WeaponKnife;
